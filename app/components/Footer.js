...
export default function Footer() {
  return (
    <footer className="bg-[333333] text-white">
      <div className="max-w-screen-lg mx-auto flex flex-wrap justify-between p-10">
        ...
        <div className="flex flex-col mb-6">
          <h5 className="font-bold text-base mb-2.5"><Link href="/our-solutions">Our Solutions</Link></h5>
        </div>

        {/* Careers */}
        
        <div className="flex flex-col mb-6">
          <h5 className="font-bold text-base mb-2.5"><Link href="/careers">Careers</Link></h5>
        </div>
