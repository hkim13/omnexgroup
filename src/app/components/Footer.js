  ...
  return (
    <footer className=" text-white w-screen">
      ...
      <div className='bg-[#333333] text-base hidden sm:block'>
        <div className='flex flex-row justify-between mx-auto max-w-[730px] p-16'>
          <div className='flex flex-col gap-2'>
            <Link href="/about-us/our-brands" className="text-[#FFFFFF] font-bold hover:text-gray-300 mb-1">About Us</Link>
            <Link href="/about-us/our-brands" className="text-gray-400 hover:text-gray-300 mb-1">Our Brands</Link>
            <Link href="/about-us/corporate-press" className="text-gray-400 hover:text-gray-300 mb-1">Corporate Press</Link>
          ...
          {/* Our solutions*/}
          <div>
            <Link href="/our-solutions" className="font-bold text-base hover:text-gray-300 mb-2.5">Our Solutions</Link>
          </div>
              {/* Careers */}
          <div>
            <Link href="/careers" className="font-bold text-base hover:text-gray-300 mb-2.5">Careers</Link>
          </div>
          <div className='flex flex-col gap-2'>
            <Link href="https://sendmoney.com" className="text-green font-bold hover:text-gray-300 mb-1">Send Money</Link>
            <Link href="https://sendmoney.com" className="text-gray-400 hover:text-gray-300 mb-1">Visit Sharemoney.com</Link>
            <Link href="/app" className="text-gray-400 hover:text-gray-300 mb-1">Download our app</Link>
            <Link href="/contact" className="text-gray-400 hover:text-gray-300 mb-1">Call Us Now</Link>
          </div>
        </div>
      ...
      <div className='flex flex-col py-7 gap-9 items-center mx-auto'>
        <div className='text-[#333333] text-xs font-bold text-center px-14 '>©2023 Omnex Group Inc. All rights reserved.<br/> Omnex Group, Inc. a licensed money transfer company NMLS No. 899521.</div>
        <div className='flex flex-row text-xs justify-between w-screen max-w-[635px] px-7'>
          <div>
            <Link href="/regulatory/state-licenses" className="text-[#4D4D4D] hover:text-black">State Licenses</Link>
          </div>
          <div>
            <Link href="/regulatory/privacy-policy" className="text-[#4D4D4D] hover:text-black">Privacy Policy</Link>
          </div>
          <div>
            <Link href="/regulatory/file-a-complaint" className="text-[#4D4D4D] hover:text-black">File a Complaint</Link>
          </div>
          <div>
            <Link href="/user-agreement" className="text-[#4D4D4D] hover:text-black">User Agreement</Link>
          </div>
        </div>
      </div>
    </footer>
